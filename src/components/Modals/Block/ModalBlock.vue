                ...
                <div class="col">
                  ...
                  <div class="position-relative d-flex align-items-center">
                    ...
                    <input
                      ...
                      :class="{
                        'is-invalid': this.$props.isInvalidSubject,
                        'is-valid': this.$props.isValidSubject,
                      }"
                      name="subject"
                      :value="this.subject"
                  ...
                  <div class="fv-plugins-message-container invalid-feedback">
                    <div
                      v-show="this.$props.errors.subject"
                      data-field="name"
  ...
  computed: {
    errorMessageSubject() {
      if (this.$props.errors.subject) {
        return this.$props.errors.subject[0];
      }
      return "";
    },
  },
