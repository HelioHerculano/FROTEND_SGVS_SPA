...
<div class="d-flex align-items-center gap-2 gap-lg-3">
    ...
    <!--begin::Primary button-->
        <a href="#" class="btn btn-sm fw-bold btn-primary"  data-bs-toggle="modal" data-bs-target="#kt_modal_new_bank" v-on:click="enableStore">
            Registar        
        </a>
    <!--end::Primary button-->
</div>
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="form-label fw-bold fs-6 text-gray-700">Nome</label>
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Nome do banco..." name="description" v-model="this.descriptionFilter" />
                ...
                <div class="col-4">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="form-label fw-bold fs-6 text-gray-700">Sigla</label>
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Sigla do banco..." name="description" v-model="this.abbreviationFilter"/>
                ...
                <div class="col-4">
                    ...
                    <div class="mb-10">
                        <!--begin::Label-->
                        <label class="form-label fw-bold fs-6 text-gray-700">Estado</label>
                        <!--end::Label-->

                        <!--begin::Select-->           
                        <select id="statusFilter" v-model="this.statusFilter" name="currnecy" aria-label="Select a Timezone" data-control="select2" data-placeholder="---Selecione aqui---" class="form-select form-select-solid">
                            <!-- <option value=""></option> -->
            ...
            <div class="col-md-12 mb-5" style="text-align: right">
                <button type="submit" class="btn btn-sm fw-bold btn-dark">Pesquisar</button>
            </div>
            ...
            <Bootstrap5Pagination :data="this.banks" @pagination-change-page="getBanks" limit="2" show-disabled>
...
export default{
    ...
    //   },
      ...
      async registerBank(){
        this.indicator = 'on'
        document.getElementById("kt_modal_new_bank_submit").setAttribute('disabled','true')
        ...
        if(res.code == 422){
            ...
            document.getElementById("kt_modal_new_bank_submit").removeAttribute('disabled')
    ...
    async getBanks(page = 1){
        ...
        this.statusFilter = $('#statusFilter').val() == null ? '' : $('#statusFilter').val() 

        // alert(this.statusFilter)

        Utilits.showLoader()
            const res = await Api.get(`/bank?page=${page}&description=${this.descriptionFilter}&abbreviation=${this.abbreviationFilter}&status=${this.statusFilter}`);
