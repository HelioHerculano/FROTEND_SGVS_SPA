...
<div class="d-flex align-items-center gap-2 gap-lg-3">
    ...
    <!--begin::Primary button-->
            <a href="#" class="btn btn-sm fw-bold btn-primary"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_account">
            Create Account        </a>
        <!--end::Primary button-->
</div>
<!--end::Actions-->
    ...
    <div class="card-body d-flex flex-column pt-13 pb-14">  
        ...
        <div class="m-0">
            ...
            <div 
                ...
                style="background-image:url('src/dist-assets/assets/media/svg/illustrations/easy/6.svg')">
            </div>
            <!--end::Illustration-->
        </div>
        <!--end::Heading-->
        ...
        <div class="text-center"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm bg-white btn-color-white bg-opacity-20"  href="../pages/careers/list.html" >
                Nurse            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
                        ...
                        <div class="me-md-5 w-100">
                                ...
                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                        ...
                                        <div class="symbol symbol-50px me-4">
                                            <span class="symbol-label">
                                                <i class="ki-duotone ki-element-11 fs-2qx text-primary"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>                        
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                ...
                                <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                        ...
                                        <div class="symbol symbol-50px me-4">
                                            <span class="symbol-label">
                                                <i class="ki-duotone ki-abstract-24 fs-2qx text-primary"><span class="path1"></span><span class="path2"></span></i>                        
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
        ...
        <div class="card-toolbar">            
            <div class="d-flex justify-content-end">
                <a href="#kt_sliders_widget_3_slider" class="carousel-control-prev position-relative me-5 active" role="button" data-bs-slide="prev">
                    <i class="ki-duotone ki-left-square fs-2x text-gray-400"><span class="path1"></span><span class="path2"></span></i>                </a>
                <a href="#kt_sliders_widget_3_slider" class="carousel-control-next position-relative me-1" role="button" data-bs-slide="next">
                    <i class="ki-duotone ki-right-square fs-2x text-gray-400"><span class="path1"></span><span class="path2"></span></i>                </a>
            </div>        
        </div>
        <!--end::Toolbar-->
    </div>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                ...
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3">
                                                    <i class="ki-duotone ki-printer fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>                                                </a>
                                                <!--end::Print-->

                                                <!--begin::Chat-->            
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3">
                                                    <i class="ki-duotone ki-sms fs-3"><span class="path1"></span><span class="path2"></span></i>                                                </a>
                                                <!--end::Chat-->

                                                <!--begin::Attach-->
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm">
                                                    <i class="ki-duotone ki-paper-clip fs-3"></i>                                                </a>
                                                <!--end::Attach-->
                                            </div>
                                            <!--end::Icon-->    
                                        </td>
